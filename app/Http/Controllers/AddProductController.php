...
class AddProductController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.dashboard',compact('products'))->with('success_message', "Product is updated  successfully!");
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.dashboard',compact('products'))->with('success_message', "Product is deleted  successfully!");
